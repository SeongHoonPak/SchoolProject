      ...
      <div class="dropdown-content" style={{ padding: 0, minWidth: 300 }}>
        <select autofocus style={{ width: 300 }} onChange={onChange}>
          ...
          <optgroup label="서울">
            ...
            <option value="서울 잠실/잠실새내">잠실/잠실새내</option>
            ...
            <option value="서울 신촌/홍대/합정">신촌/홍대/합정</option>
            ...
            <option value="서울 건대/군자/구의">건대/군자/구의</option>
            <option value="서울 수유/미아">수유/미아</option>
            <option value="서울 태릉/노원/도봉/창동">
              태릉/노원/도봉/창동
            </option>
            <option value="서울 영등포/여의도">영등포/여의도</option>
            <option value="서울 천호/길동/둔촌">천호/길동/둔촌</option>
            <option value="서울 구로/금천/오류/신도림">
              구로/금천/오류/신도림
            </option>
            <option value="서울 연신내/불광/응암">연신내/불광/응암</option>
            <option value="서울 성신여대/성북/월곡">성신여대/성북/월곡</option>
            <option value="서울 동대문/을지로/충무로/신당/약수">
              동대문/을지로/충무로/신당/약수
            </option>
            <option value="서울 장안동/답십리">장안동/답십리</option>
            <option value="서울 왕십리/성수/금호">왕십리/성수/금호</option>
            <option value="서울 상봉/중랑/면목">상봉/중랑/면목</option>
          </optgroup>
          <optgroup label="경기">
            ...
            <option value="경기 시흥/월곶">시흥/월곶</option>
            <option value="경기 평택/송탄/안성">평택/송탄/안성</option>
            <option value="경기 김포">김포</option>
            <option value="경기 구리">구리</option>
            <option value="경기 남양주(오남/조안/화도/진접)">
              남양주(오남/조안/화도/진접)
            </option>
            <option value="경기 양주/동두천/연천">양주/동두천/연천</option>
            <option value="경기 가평/청평">가평/청평</option>
            <option value="경기 수원역/구운/장안/세류">
              수원역/구운/장안/세류
            </option>
            <option value="경기 성남/분당/위례">성남/분당/위례</option>
            <option value="경기 동탄/화성/오산/병점">
              동탄/화성/오산/병점
            </option>
            <option value="경기 안산 중앙역">안산 중앙역</option>
            ...
            <option value="경기 제부도/대부도">제부도/대부도</option>
          </optgroup>
          <optgroup label="인천">
            ...
            <option value="인천 강화/옹진">강화/옹진</option>
            ...
            <option value="인천 송도/연수">송도/연수</option>
            <option value="인천 중구(월미도/신포/동인천/연안부두)">
              중구(월미도/신포/동인천/연안부두)
            </option>
            <option value="인천 동암/간석">동암/간석</option>
            <option value="인천 용현/숭의/도화/동구">
              용현/숭의/도화/동구
            </option>
          </optgroup>
          <optgroup label="강원">
            <option value="강원 춘천/강촌">춘천/강촌</option>
            <option value="강원 원주">원주</option>
            <option value="강원 경포대/사천/주문진/정동진">
              경포대/사천/주문진/정동진
            </option>
            <option value="강원 영월/정선">영월/정선</option>
            ...
            <option value="강원 강릉역/교동/옥계">강릉역/교동/옥계</option>
            <option value="강원 속초/고성">속초/고성</option>
            <option value="강원 동해/삼척/태백">동해/삼척/태백</option>
            <option value="강원 홍천/횡성">홍천/횡성</option>
          </optgroup>
          <optgroup label="제주">
            <option value="제주 제주시/제주공항">제주시/제주공항</option>
          ...
          <optgroup label="충북">
            ...
            <option value="충북 청주 홍덕구/서원구">청주 홍덕구/서원구</option>
            <option value="충북 청주 상당구/청원구">청주 상당구/청원구</option>
            <option value="충북 충주/수안보">충주/수안보</option>
            <option value="충북 제천/단양">제천/단양</option>
            <option value="충북 진천/음성">진천/음성</option>
            <option value="충북 보은/괴산/증평/영동">
              보은/괴산/증평/영동
            </option>
          </optgroup>
          <optgroup label="충남/세종">
            <option value="충남/세종 천안서북구">천안서북구</option>
            <option value="충남/세종 천안동남구">천안동남구</option>
            <option value="충남/세종 아산">아산</option>
            <option value="충남/세종 공주/동학/세종">공주/동학/세종</option>
            <option value="충남/세종 계룡/금산/논산/청양">
              계룡/금산/논산/청양
            </option>
            <option value="충남/세종 예산/홍성">예산/홍성</option>
            <option value="충남/세종 당진">당진</option>
            <option value="충남/세종 서천/부여">서천/부여</option>
            <option value="충남/세종 보령/대천해수욕장">
              보령/대천해수욕장
            </option>
            <option value="충남/세종 태안/안면도/서산">태안/안면도/서산</option>
          </optgroup>
          <optgroup label="부산">
            <option value="부산 해운대/센텀시티/재송">
              해운대/센텀시티/재송
            </option>
            <option value="부산 송정/기장/정관">송정/기장/정관</option>
            <option value="부산 광안리/수영">광안리/수영</option>
            ...
            <option value="부산 연산/토곡">연산/토곡</option>
            <option value="부산 동래/사직/온천장/부산대/구서/서동">
              동래/사직/온천장/부산대/구서/서동
            </option>
            <option value="부산 사상/엄궁/학장">사상/엄궁/학장</option>
            <option value="부산 덕천/화명/만덕/구포">
              덕천/화명/만덕/구포
            </option>
            <option value="부산 하단/명지/김해공항">하단/명지/김해공항</option>
          ...
          <optgroup label="울산">
            <option value="울산 남구/중구">남구/중구</option>
            <option value="울산 동구/북구/울주군">동구/북구/울주군</option>
          </optgroup>
          <optgroup label="경남">
            ...
            <option value="경남 김해/장유">김해/장유</option>
            <option value="경남 양산/밀양">김해/장유</option>
            <option value="경남 진주">김해/장유</option>

            <option value="경남 거제/통영/고성">거제/통영/고성</option>
            <option value="경남 사천/남해">사천/남해</option>
            <option value="경남 하동/산청/함양">하동/산청/함양</option>
          ...
          <optgroup label="경북">
            <option value="경북 포항/남구">포항/남구</option>
            <option value="경북 포항/북구">포항/북구</option>
            <option value="경북 경주">경주</option>
            <option value="경북 구미">구미</option>
            <option value="경북 경산">경산</option>
            <option value="경북 안동">안동</option>
            <option value="경북 영천/청도">영천/청도</option>
            <option value="경북 김천/칠곡/성주">김천/칠곡/성주</option>
            <option value="경북 문경/상주/영주">문경/상주/영주</option>
            <option value="경북 예천/군위/의성/봉화">
              예천/군위/의성/봉화
            </option>
            <option value="경북 울진/영덕/청송">울진/영덕/청송</option>
            <option value="경북 울릉도">울릉도</option>
          </optgroup>
          <optgroup label="광주">
            <option value="광주 상무지구/금호지구">상무지구/금호지구</option>
            <option value="광주 유스퀘어/서구">유스퀘어/서구</option>
            <option value="광주 첨단지구/하남지구">첨단지구/하남지구</option>
            <option value="광주 송정역/광산구">송정역/광산구</option>
            <option value="광주 충장로/대인시장">충장로/대인시장</option>
            <option value="광주 국립아시아문화전당">국립아시아문화전당</option>
            <option value="광주 광주역/전대사거리">광주역/전대사거리</option>
            <option value="광주 동구/남구">동구/남구</option>
          ...
          <optgroup label="전남">
            ...
            <option value="전남 해남/완도/진도">해남/완도/진도</option>
          ...
          <optgroup label="전주/전북">
            ...
            <option value="전주/전북 남원/임실/순창">남원/임실/순창</option>
            <option value="전주/전북 무주/진안/장수">무주/진안/장수</option>
